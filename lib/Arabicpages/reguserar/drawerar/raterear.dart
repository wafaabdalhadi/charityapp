...
void main() {
  runApp(const Raterearpage());
}

class Raterearpage extends StatelessWidget {
  const Raterearpage({super.key});
...
class Raterearpage1 extends StatefulWidget {
  const Raterearpage1({super.key});

  @override
  State<Raterearpage1> createState() => _Raterearpage1State();
}

class _Raterearpage1State extends State<Raterearpage1> {
