...
void main() {
  runApp(const Czakatgrear1());
}

class Czakatgrear1 extends StatelessWidget {
  const Czakatgrear1({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: CzakatgrearScreen(),
    );
  }
}

class CzakatgrearScreen extends StatefulWidget {
  const CzakatgrearScreen({super.key});

  @override
  _CzakatgrearScreenState createState() => _CzakatgrearScreenState();
}

class _CzakatgrearScreenState extends State<CzakatgrearScreen> {
