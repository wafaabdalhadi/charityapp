...
void main(List<String> args) {
  runApp(const Moneyar11());
}

class Moneyar11 extends StatelessWidget {
  const Moneyar11({super.key});
...
class Moneyar111 extends StatefulWidget {
  const Moneyar111({super.key});

  @override
  State<Moneyar111> createState() => _Moneyar111State();
}

class _Moneyar111State extends State<Moneyar111> {
