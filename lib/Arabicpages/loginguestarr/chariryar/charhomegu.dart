...
void main(List<String> args) {
  runApp(const Charityhomeguar1());
}

class Charityhomeguar1 extends StatelessWidget {
  const Charityhomeguar1({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: Charityhomeguar(),
    );
  }
}

class Charityhomeguar extends StatefulWidget {
  const Charityhomeguar({super.key});

  @override
  State<Charityhomeguar> createState() => _CharityhomeguarState();
}

class _CharityhomeguarState extends State<Charityhomeguar> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false,
