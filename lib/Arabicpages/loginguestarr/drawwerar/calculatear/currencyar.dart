...
import 'package:flutter_application_2/Arabicpages/loginguestarr/drawwerar/calculatear/zakattypear.dart';
import 'package:flutter_application_2/Arabicpages/loginguestarr/mainpagearguest.dart';

void main() {
  runApp(const Currencyar());
}

class Currencyar extends StatelessWidget {
  const Currencyar({super.key});
...
class Currencyar1 extends StatefulWidget {
  const Currencyar1({super.key});

  @override
  State<Currencyar1> createState() => _Currencyar1State();
}

class _Currencyar1State extends State<Currencyar1> {
                        ...
                        setState(
                          () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Zakattypeguar1()),
                            );
                          },
                        );
                      },
