...
void main() {
  runApp(const Czakatg1());
}

class Czakatg1 extends StatelessWidget {
  const Czakatg1({super.key});
...
class CzakatgScreen extends StatefulWidget {
  const CzakatgScreen({super.key});

  @override
  _CzakatgScreenState createState() => _CzakatgScreenState();
}

class _CzakatgScreenState extends State<CzakatgScreen> {
