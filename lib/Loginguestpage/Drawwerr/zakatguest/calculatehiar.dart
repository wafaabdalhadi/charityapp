...
void main() {
  runApp(const Czakathgue1());
}

class Czakathgue1 extends StatelessWidget {
  const Czakathgue1({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: CzakathgueScreen(),
    );
  }
}

class CzakathgueScreen extends StatefulWidget {
  const CzakathgueScreen({super.key});

  @override
  _CzakathgueScreenState createState() => _CzakathgueScreenState();
}

class _CzakathgueScreenState extends State<CzakathgueScreen> {
