...
void main(List<String> args) {
  runApp(const Clothes11());
}

class Clothes11 extends StatelessWidget {
  const Clothes11({super.key});
          ...
          body: Column(
            children: [
              ...
              Container(
                ...
                child: const Text(
                  'Feel free to contribute a wide range of gently used clothing to support our cause. ',
                  style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600),
                ),
              ),
              Container(
                margin: const EdgeInsets.symmetric(horizontal: 12),
                child: const Text(
                  'Your contributions will help us make a significant impact in the lives of those in need. Thank you for being part of our mission',
                  style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600),
                ),
              )
            ],
